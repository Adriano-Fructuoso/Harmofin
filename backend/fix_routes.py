#!/usr/bin/env python3
"""
Script para corrigir as rotas de procedimentos
"""

def corrigir_procedimentos_router():
    """Corrige o arquivo de rotas de procedimentos"""
...
'''
    ...
    with open('app/routers/procedimentos.py', 'w', encoding='utf-8') as f:
        f.write(conteudo_corrigido)
    
    print("✅ Arquivo de rotas corrigido!")

if __name__ == "__main__":
    corrigir_procedimentos_router() 